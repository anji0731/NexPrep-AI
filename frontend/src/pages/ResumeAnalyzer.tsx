            ...
            <form onSubmit={handleSubmit} className="lg:col-span-8 bg-white p-8 sm:p-10 rounded-[20px] border border-[#ECECEC] shadow-minimal space-y-8 text-left">
              ...
              <div className="space-y-3">
                ...
                <div
                  ...
                  onDrop={handleDrop}
                  className={`border-2 border-dashed rounded-[20px] p-10 text-center transition-all cursor-pointer flex flex-col items-center justify-center gap-4 ${
                    file ? 'border-blue-500 bg-blue-50/10' : 'border-slate-200 hover:border-slate-350 bg-slate-50/20'
                  }`}
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex gap-2 bg-slate-50 border border-slate-200/60 p-1 rounded-lg">
                    <button
                      ...
                      className={`px-3 py-1 text-[10px] font-bold uppercase rounded-md transition-all ${
                        jdMode === 'text' ? 'bg-white text-slate-800 shadow-sm border border-slate-200' : 'text-slate-500 hover:text-slate-800'
                      }`}
                    >
                      Paste Text
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 text-[10px] font-bold uppercase rounded-md transition-all ${
                        jdMode === 'file' ? 'bg-white text-slate-800 shadow-sm border border-slate-200' : 'text-slate-500 hover:text-slate-800'
                      }`}
                    >
                      Upload PDF
                    </button>
                ...
                {jdMode === 'text' ? (
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-[20px] p-6 text-center transition-all cursor-pointer flex flex-col items-center justify-center gap-3 ${
                      jdFile ? 'border-blue-500 bg-blue-50/10' : 'border-slate-200 hover:border-slate-350 bg-slate-50/20'
                    }`}
          ...
          <div className="space-y-12 text-left">
            ...
            {result.recruiter_decision && (
              <motion.div 
                ...
                whileInView="visible"
                viewport={{ once: true, margin: "-50px" }}
                className={`p-8 sm:p-10 rounded-[20px] border shadow-minimal space-y-6 text-left ${
                  result.recruiter_decision.decision_status.toLowerCase() === 'strong hire' ? 'bg-green-50/20 border-green-200' :
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200/50 pb-4 gap-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${
                      result.recruiter_decision.decision_status.toLowerCase() === 'strong hire' ? 'bg-green-100 text-green-700 border-green-200' :
                  ...
                  <span className={`inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm border ${
                    result.recruiter_decision.decision_status.toLowerCase() === 'strong hire' ? 'bg-green-500 text-white border-green-600' :
                  ...
                  <div className="lg:col-span-4 p-6 bg-slate-50/50 rounded-[16px] border border-[#ECECEC] flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <span className={`inline-block px-3 py-1 rounded-lg text-xs font-bold uppercase ${
                        result.jd_compatibility.final_recommendation.toLowerCase().includes('excellent') ? 'bg-green-50 text-green-700 border border-green-150' :
                              ...
                              <div className="p-6 pt-0 border-t border-[#ECECEC] space-y-4 text-xs font-semibold">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-100 pt-4">
                                  ...
                                  <div className="space-y-1">
                                    ...
                                    <span className={`inline-block px-2.5 py-0.5 rounded text-[10px] font-bold mt-1 uppercase ${
                                      path.learning_difficulty.toLowerCase() === 'easy' ? 'bg-green-50 text-green-700 border border-green-150' :
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-4 p-6 bg-slate-50/50 rounded-[16px] border border-[#ECECEC] text-center space-y-4">
                    ...
                    <span className={`inline-block px-4 py-1.5 rounded-xl text-sm font-bold uppercase ${
                      result.ai_recruiter_feedback.shortlist_decision.toLowerCase() === 'yes' ? 'bg-green-50 text-green-700 border border-green-150' :
                        ...
                        <tr key={idx} className="hover:bg-slate-50/40 transition-colors">
                          ...
                          <td className="py-4 pl-4 text-right">
                            <span className={`inline-block px-2.5 py-0.5 rounded text-[10px] font-bold uppercase ${
                              company.preparation_level.toLowerCase() === 'high' ? 'bg-red-50 text-red-600 border border-red-100' :
